...
export const MOCK_CHATS: MockChatEntry[] = [
  { id: "1", name: "Priya Sharma", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=priya", lastMessage: "Did you watch that vibe I sent? 🔥", time: "2:34 PM", unread: 3, online: true, blazeGrind: 7, pinned: true },
  { id: "2", name: "Rahul Verma", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=rahul", lastMessage: "🎤 Voice message", time: "1:15 PM", unread: 0, online: false, blazeGrind: 14, pinned: false },
  ...
  { id: "4", name: "Ananya K", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=ananya", lastMessage: "You: 😂😂😂", time: "Yesterday", unread: 0, online: true, blazeGrind: 3, pinned: false },
  { id: "5", name: "Kiran Reddy", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=kiran", lastMessage: "🎮 Game Challenge!", time: "Yesterday", unread: 1, online: false, blazeGrind: 30, pinned: false },
  { id: "6", name: "Sneha Patel", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=sneha", lastMessage: "📷 Photo", time: "Mon", unread: 0, online: false, blazeGrind: 0, pinned: false },
 ...
 */
export function getChatById(chatId?: string | null): { displayName: string; avatar: string; isGroup: boolean } {
  if (!chatId) {
  ...
  if (fromMock) {
    return { displayName: fromMock.name, avatar: fromMock.avatar, isGroup: !!fromMock.isGroup };
  }
  ...
  if (chatId.startsWith('custom_')) {
    ...
    if (matched) {
      return { displayName: matched.displayName, avatar: matched.avatar, isGroup: false };
    }
    // Fall back to a readable version of the username itself
    return { displayName: username, avatar: `https://i.pravatar.cc/150?u=${username}`, isGroup: false };
  }
